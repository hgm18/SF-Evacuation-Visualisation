...
let app = new Vue ({
    ...
    data: {
        ...
        sectionTitleLong: ["Introduction", "Target Forces",  "Boundary Forces", "Inter-Agent Forces","The Full SFM"],
        sectionSubtitle: ["Introduction","Moving Towards a Target (Exit)","Repulsive Forces","Inter-Agent Forces","The Full Social Force Model"],
